...
class FFPLAY():
    ...
    def download_from_youtube(self,type):
        ...
        msg5="reproducción y seleccione Copiar URL. A continuación,\n"
        msg6="pegue la URL copiada en el campo a continuación usando\n"
        msg7="las teclas del teclado ctrl + v."
        ...
        try:
            ...
            ys.download(output_path=yt_folder,filename=None,skip_existing=True)
        except Exception:
            pass
        finally:    
            self.on_complete(yt_folder,ys.default_filename)
    ...
    def load_library(self,db,skip=None):
        ...
        if len(self.Media_Dict)==0:
            ...
            self.active_database=db
            root.title(f"Mi Reproductor Multimedia 5.4 ({db.replace("_"," ")} Biblioteca), Reproducción en un Dispositivo de Audio: {self.Active_Device}")
    ...
    def select_output_device(self,device):
        try:
            ...
            Level.set(5)
            self.Master_Volume.SetMasterVolumeLevelScalar(Level.get()/ 100, None)
            root.title(f"Mi Reproductor Multimedia 5.4 ({self.active_database.replace("_"," ")} Biblioteca), Reproducción en un Dispositivo de Audio: {self.Active_Device}")
        except Exception as ex:
...
if __name__ == '__main__':
    ...
    root.title("Mi Reproductor Multimedia 5.4")
