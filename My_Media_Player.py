...
if __name__ == '__main__':
    ...
    stop_btn=tk.Button(ctrl_frame,text="Stop",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    mute_btn=tk.Button(ctrl_frame,text="Mute",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    repeat_btn=tk.Button(ctrl_frame,text="Repeat",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    pause_btn=tk.Button(ctrl_frame,text="Pause",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    next_btn=tk.Button(ctrl_frame,text="Next",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    previous_btn=tk.Button(ctrl_frame,text="Previous",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    shuffle_btn=tk.Button(ctrl_frame,text="Shuffle Play",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    play_btn=tk.Button(ctrl_frame,text="Play",foreground="#ffffff",image=btn_skin, compound="center",font=media_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
