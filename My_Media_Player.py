...
class FFPLAY():
    def __init__(self,parent):
        ...
        wid=int(0.0365*(work_area[2]*0.8))
        self.media_list=Listbox(self.scroll_window,foreground="#ffffff",background="#000000",selectbackground="#4cffff",
                                selectforeground="#000000",width=wid,font=media_font,yscrollcommand=self.vbar.set )  
    ...
    def get_music_metadata(self,file,data):# Can Return title, artist, album, genre, track
        metadata=f"format_tags={data}"
        try:
            proc=subprocess.Popen(["ffprobe","-v","error","-of","csv=s=x:p=0","-show_entries",metadata,file],
        ...
        if self.next_ready:
            ...
            while self.listener.running:
                try:
                    ...
                    self.remove_media_file(key)# Remove corrupted Image File From Library
                    continue
                ...
                try:
                    ...
                    if self.active_media=="image":
                        try:
                            ...
                            self.remove_media_file(key)# Remove corrupted Image File From Libraryqq
                            continue
                except Exception as e:
            ...
            if not self.ffplay_running:# Not Running
                ...
                try:
                    ...
                    if self.active_media=="video":
                        ...
                        # Get Song title, artist, album, genre or track. If Missing title, Do Not Use -showmode Because Error Generated At GetWindowTitle
                        err,title=self.get_music_metadata(file,"title")
                        if err=="":
                            if title=="":# No title
                                ...
                                self.process_ffplay=subprocess.Popen(["ffplay","-ss",str(self._start_time),"-t",str(self._duration),"-x",window_wid,"-y",
                                                                    ...
                                                                    stdin=subprocess.PIPE,stdout=subprocess.PIPE,creationflags=subprocess.CREATE_NO_WINDOW)
                        else:raise Exception("ffprobe Get Song Title")
                    poll=""
                    count=0# Exit Backup
                    while poll!=None and count<=40:# 40 = 4 Seconds Max Time For Loop
                        ...
                        try:
                            ...
                            pass
                    if count>=40:
                        self.remove_media_file(key)# Remove corrupted Video File From Library
                        return
    ...
    def rotate_image(self):
        ...
        if angle!=None:
            try:
                ...
                msg2=f"Error: '{e}'"
                messagebox.showerror(title, msg1+msg2)
    def remove_media_file(self,key=None):
    ...
    def load_music_menu(self):
        ...
        showmode_menu=Menu(self.menubar,background='aqua',foreground='black',tearoff=0)# File Menu and commands
...
if __name__ == '__main__':
    ...
    media_font=font.Font(family='Times New Romans', size=10, weight='normal', slant='italic')
    ...
    btn_skin=tk.PhotoImage(file=os.path.join(pgm_Path, '400x40_dark.png'))
    ...
    volume_lbl=tk.Button(title_frame,text='Master Volume',image=btn_skin, compound="center",width=pix_wid+2,height=20,activeforeground='#4cffff',
                    background="#bcbcbc",foreground="#ffffff",font=button_font,justify="center",relief='sunken',borderwidth=5)
    ...
    title_lbl=tk.Button(title_frame,text="",image=title_skin, compound="center",height=20,activeforeground='#4cffff',
                    background="#aeaeae",foreground="#ffffff",font=button_font,justify="center",relief='sunken',borderwidth=5)
    ...
    time_scale=tk.Scale(slider_frame, relief="sunken",orient='horizontal',resolution=0,
                        bg="#333333",borderwidth=5,font=button_font,fg="#ffffff",troughcolor="#001829",  
    ...
    quit_btn=tk.Button(ctrl_frame,text="Quit",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
    ...
    stop_btn=tk.Button(ctrl_frame,text="Stop",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    mute_btn=tk.Button(ctrl_frame,text="Mute",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    repeat_btn=tk.Button(ctrl_frame,text="Repeat",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    pause_btn=tk.Button(ctrl_frame,text="Pause",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    next_btn=tk.Button(ctrl_frame,text="Next",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    previous_btn=tk.Button(ctrl_frame,text="Previous",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    shuffle_btn=tk.Button(ctrl_frame,text="Shuffle Play",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
    ...
    play_btn=tk.Button(ctrl_frame,text="Play",foreground="#ffffff",image=btn_skin, compound="center",font=button_font,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=20)
