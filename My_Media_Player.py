...
class FFPLAY():
    ...
    def bound_keys(self,key):
        if key.keysym=="e" or key.keysym=="E":self.quit(self)
        ...
        elif key.keysym=="XF86AudioPlay":self.ctrl_btn_clicked(self,"btn play")
            ...
            if key.keysym=="Right":
                ...
                self.send_keyboard_key("full screen")
            elif key.keysym=="p" or key.keysym=="P":
                self.pause(self)
            elif key.keysym=="q" or key.keysym=="Q" or key.keysym=="Escape":
                self.ctrl_btn_clicked(self,"stop")
            elif key.keysym=="w" or key.keysym=="W":
                self.send_keyboard_key("showmode")
            elif key.keysym=="XF86AudioNext":
                self.ctrl_btn_clicked(self,"next")
            elif key.keysym=="XF86AudioPrev":
    ...
    def load_menubar(self):
        ...
        bound_menu.add_command(label="View Bound Keyboard Keys",command=lambda:os.system(f"notepad.exe {self.readme_path}"))
...
def bind_keyboard():
    keys=['<KeyRelease-p>','<KeyRelease-P>','<KeyRelease-m>','<KeyRelease-M>','<KeyRelease-Right>','<KeyRelease-Left>',
            ...
            '<KeyRelease-Escape>','<KeyRelease-w>','<KeyRelease-W>','<KeyRelease-e>','<KeyRelease-E>','<KeyRelease-r>',
            '<KeyRelease-R>','<KeyRelease-XF86AudioPlay>','<XF86AudioMute>','<KeyRelease-XF86AudioPrev>',
            '<KeyRelease-XF86AudioNext>','<KeyRelease-XF86AudioRaiseVolume>','<KeyRelease-XF86AudioLowerVolume>']
