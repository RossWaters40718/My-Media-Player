...
class FFPLAY():
    ...
    def _stop(self,skip_menu=None):# Used For Stopping Media File
        ...
        if not self.seeking:
            ...
            mute_btn.config(background="#bcbcbc",foreground="#ffffff")# Disabled
            Muted.set(False)
            ...
            if btn=="btn play":
                ...
                if self.ffplay_running:
                    if Muted.get()==False:
                        ...
                        mute_btn.config(background="#00ffff",foreground="#ff0000")# Active
                        Muted.set(True)
                    else:# Unmute Clicked
                        self.Master_Volume.SetMute(False, None)
                        mute_btn.config(background="#bcbcbc",foreground="#ffffff")# Disabled
...
if __name__ == '__main__':
    ...
    btn_font1=font.Font(family='Times New Romans', size=16, weight='normal', slant='roman')
    btn_font2=font.Font(family='Times New Romans', size=21, weight='normal', slant='roman')
    ...
    btn_skin=tk.PhotoImage(file=os.path.join(pgm_Path, '400x35_dark.png'))
    ...
    mute_btn=tk.Button(ctrl_frame,text="🔇",foreground="#ffffff",image=btn_skin, compound="center",font=btn_font2,relief="sunken",
                       background="#bcbcbc",borderwidth=5,activeforeground="#4cffff",width=1,height=28,justify="center",anchor="s")
